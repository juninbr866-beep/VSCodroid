...
TOOLCHAIN_LIBRARIES = {
    ...
    "libffi.so": ("libffi", "MIT"),
    "libandroid-utimes.so": ("libandroid-utimes", "BSD-2-Clause"),
    "libbz2.so.1.0.8": ("bzip2", "bzip2-1.0.6"),
    "libcapstone.so": ("Capstone", "BSD-3-Clause"),
    "libcharset.so": ("libcharset", "LGPL-2.1-or-later"),
    "libexslt.so": ("libxslt", "MIT"),
    "libgmpxx.so": ("GMP", "LGPL-3.0"),
    "libhistory.so.8.3": ("readline", "GPL-3.0"),
    "libicudata.so.78.3": ("ICU", "ICU"),
    "libicui18n.so.78.3": ("ICU", "ICU"),
    "libicuio.so.78.3": ("ICU", "ICU"),
    "libicutest.so.78.3": ("ICU", "ICU"),
    "libicutu.so.78.3": ("ICU", "ICU"),
    "libicuuc.so.78.3": ("ICU", "ICU"),
    "libonig.so": ("Oniguruma", "BSD-2-Clause"),
    "libpcre2-16.so": ("PCRE2", "BSD-3-Clause"),
    "libpcre2-32.so": ("PCRE2", "BSD-3-Clause"),
    "libpcre2-posix.so": ("PCRE2", "BSD-3-Clause"),
    "libreadline.so.8.3": ("readline", "GPL-3.0"),
    "libsqlite3.53.4.so": ("SQLite", "Public Domain"),
    "libsqlite3.so.3.53.4": ("SQLite", "Public Domain"),
    "libtidy.so": ("tidy", "W3C"),
    "libxml2.so.16.1.4": ("libxml2", "MIT"),
    "libxslt.so": ("libxslt", "MIT"),
    "libz.so.1.3.2": ("zlib", "Zlib"),
    "libzip.so": ("libzip", "BSD-3-Clause"),
}
...
NOTICE_DIRS = {
    ...
    "libandroid-utimes": "usr/share/doc/libandroid-utimes",
    "Capstone": "usr/share/doc/capstone",
    "libcharset": "usr/share/doc/libxml2",
    "Oniguruma": "usr/share/doc/oniguruma",
    "tidy": "usr/share/doc/tidy",
    "libxml2": "usr/share/doc/libxml2",
    "libxslt": "usr/share/doc/libxslt",
    "libzip": "usr/share/doc/libzip",
}
