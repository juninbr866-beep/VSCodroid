...
- The landscape input preview now follows editor input events and EditContext updates, so deletion, composition, focus changes, and all editor input paths stay synchronized.

## [1.5.1] - 2026-09-23

### Fixed

- The landscape input preview now follows the editor's EditContext text, so deleting characters also updates the preview.
