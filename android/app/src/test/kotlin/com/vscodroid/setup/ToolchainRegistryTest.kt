...
class ToolchainRegistryTest {
    ...
    inner class CatalogTest {
        ...
        @Test
        fun `has exactly 10 toolchains`() {
            assertEquals(10, ToolchainRegistry.available.size)
        }
    ...
    inner class FindTest {
        ...
        @ValueSource(strings = ["toolchain_ruby", "toolchain_java", "toolchain_bun", "toolchain_deno", "toolchain_zig", "toolchain_php", "toolchain_perl", "toolchain_lua", "toolchain_dart", "toolchain_kotlin"])
        ...
        @CsvSource("ruby,toolchain_ruby", "java,toolchain_java", "bun,toolchain_bun", "deno,toolchain_deno", "zig,toolchain_zig", "php,toolchain_php", "perl,toolchain_perl", "lua,toolchain_lua", "dart,toolchain_dart", "kotlin,toolchain_kotlin")
